...
public class UserResource {
	...
	public ResponseEntity<List<UserDTO>> findAll() {
		...
		List<UserDTO> listDto = list.stream().map(x -> new UserDTO(x)).collect(Collectors.toList()); // converte cada elemento da list em um elemento DTO
		return ResponseEntity.ok().body(listDto);
	}
	
	@RequestMapping(value = "/{id}", method=RequestMethod.GET)
	public ResponseEntity<UserDTO> findById(@PathVariable String id) { //@PathVariable para firmar a amarraçao entre o id da url com o argumento
